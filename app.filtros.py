...
minimo = st.slider("Vendas mínimas",min_value=0,max_value=230,value=100) # valor inicial
...
meses = st.multiselect("Selecione os meses",options=df["Mês"].tolist(), default=["Jan", "Fev"]) # pré-selecionados
